...
- Name: ui.spec.js >> Nebula Cleaner UI >> junk files tab shows results
- Location: tests\ui.spec.js:140:3
...
Locator:  locator('#junk-list .file-item')
Expected: 2
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#junk-list .file-item')
