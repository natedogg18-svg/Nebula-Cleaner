...
- Name: ui.spec.js >> Nebula Cleaner UI >> large files tab shows results and select all works
- Location: tests\ui.spec.js:97:3
...
```ts
  ...
  5   | 
  6   | const APP_URL = `file://${path.resolve(__dirname, '../src/renderer/index.html')}`;
  7   | 
