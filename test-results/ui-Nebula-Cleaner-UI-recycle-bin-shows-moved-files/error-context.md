...
- Name: ui.spec.js >> Nebula Cleaner UI >> recycle bin shows moved files
- Location: tests\ui.spec.js:115:3
...
Locator:  locator('#bin-list .file-item')
Expected: 2
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#bin-list .file-item')
